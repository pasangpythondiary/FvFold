...
from fvfold.util.model_out import get_inputs_from_fasta, bin_matrix
from fvfold.util.util import load_full_seq, one_hot_seq, lev_distance, _aa_dict, _rev_aa_dict
