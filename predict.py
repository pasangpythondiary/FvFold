...
import fvfold
from fvfold.models.AbResNet import load_model
from fvfold.models.ModelEnsemble import ModelEnsemble
from fvfold.build_fv.build_cen_fa import build_initial_fv, get_cst_defs, refine_fv
from fvfold.metrics.rosetta_ab import get_ab_metrics
from fvfold.util.pdb import renumber_pdb
...
def build_structure(model,
    ...
    out_pdb = os.path.join("pred/", "{}.pdb".format(filename))
...
def _cli():
    ...
    device_type = 'cuda:0' if torch.cuda.is_available(
    ...
    fasta_files = glob("data/pred/*.fasta")
    print(fasta_files)
